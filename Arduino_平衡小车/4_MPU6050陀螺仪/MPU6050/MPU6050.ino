...
void loop() {
    ...
    // 输出陀螺仪的数据
    Serial.print("x轴角度: "); Serial.println(ax);
    Serial.print("y轴角度: "); Serial.println(ay);
    Serial.print("z轴角度: "); Serial.println(az);
    Serial.print("x轴角速度: "); Serial.println(gx);
    Serial.print("y轴角速度: "); Serial.println(gy);
    Serial.print("z轴角速度: "); Serial.println(gz);
    Serial.println();
    delay(1500);
}
